...
--
-- Client :  127.0.0.1
-- Généré le :  Ven 04 Septembre 2015 à 16:17
...
(15, 'div', 'avant apropos', 'A propos', 'Le Centre de Formation 2 mille (CF2m), implanté à Saint-Gilles, propose des formations professionnelles en informatique pour demandeurs d’emploi. Il a pour mission de lutter contre toutes les formes d’exclusion sociale et culturelle et contre les discriminations dans l’accès à la formation et à l’emploi.\n\nLe CF2m est donc actif dans le secteur de l’insertion sociale et professionnelle pour demandeurs d''emploi.\n\nÉgalement acteur dans les secteurs de l’éducation permanente, des réseaux de savoirs et de l’économie sociale, le Centre de Formation 2mille propose aux demandeurs d’emploi des formations professionnelles en informatique et plus particulièrement dans le secteur des TIC (Technologies de l’Information et de la Communication). \n\nCes formations sont réactualisées chaque année en fonction de l’évolution des technologies et du marché de l’emploi.\n\nEn partenariat avec Bruxelles-Formation et Actiris\n\nVisant l’insertion professionnelle dans des secteurs porteurs, ces formations sont dispensées en cours du jour en partenariat avec Bruxelles-Formation et Actiris. Elles se clôturent par un stage en entreprise de 6 semaines. \n\nEnfin, un accompagnement social et une aide à la recherche d’emploi complètent les services offerts aux demandeurs d’emploi.\n\nLe CF2m, un acteur de l''économie sociale à Bruxelles\n\nLe Centre de Formation 2mille est également actif dans le secteur de l’économie sociale : d’une part dans le réemploi informatique et la dématérialisation de déchets électriques et électroniques, et d’autre part, dans la communication numérique (services graphiques : pré-presse, imprimerie et création de sites web).\n\nEn outre, le CF2m est doté d’un pôle recherche et développement dans le secteur environnemental pour l''accès aux ressources et à l''entreprenariat social.', 1, 14),
